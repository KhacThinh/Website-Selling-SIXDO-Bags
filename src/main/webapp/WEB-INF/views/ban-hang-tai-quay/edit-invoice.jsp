            ...
            <div class="list gioHangTaiQuay" style="margin-top: 30px">
                <c:forEach var="product" items="${productsEdit}">
                    ...
                    <div class="item productInCart"
                        ...
                        <div style="color: black; font-size: 16px; margin-right: 50px;"><fmt:formatNumber
                                value="${product.chiTietSanPham.giaBan}" type="currency"/></div>
                        <div class="returnPriceCart returnPriceCart${product.chiTietSanPham.id}"
                             style="color: black; font-size: 16px;"><fmt:formatNumber
                                value="${product.chiTietSanPham.giaBan*product.soLuong}" type="currency"/></div>
                        <div></div>
                    </div>
                </c:forEach>
