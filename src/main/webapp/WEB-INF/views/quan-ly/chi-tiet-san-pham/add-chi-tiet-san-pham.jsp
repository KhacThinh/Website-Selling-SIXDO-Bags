    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body" >
                <form:form method="POST" action="/chi-tiet-san-pham/add" enctype="multipart/form-data" modelAttribute="chiTietSanPham" id="yourFormId">
                    <div class="row">
                        <div class="col-md-6">
...
<script>
    ...
    function validateForm() {
        ...
        if (soLuong.trim() === '') {
            ...
            document.getElementById('soLuongError').innerText = 'Số lượng phải là một số.';
            isValid = false;
        } else {
        ...
        if (giaNhap.trim() === '') {
            ...
            document.getElementById('giaNhapError').innerText = 'Giá nhập phải là một số.';
            isValid = false;
        } else {
        ...
        if (giaBan.trim() === '') {
            ...
            document.getElementById('giaBanError').innerText = 'Giá bán phải là một số.';
            isValid = false;
        } else {
