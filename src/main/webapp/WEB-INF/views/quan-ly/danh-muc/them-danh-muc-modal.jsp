...
<!-- Modal -->
<div class="modal modal-xl" id="addModelDanhMuc" tabindex="-1" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form:form method="POST" action="${ action }" id="myForm" modelAttribute="DM"
