...
<div class="container">
    ...
    <div class="row">
        ...
        <button type="button" class="btn btn-outline-secondary mt-5 rounded-pill" data-bs-toggle="modal"
                data-bs-target="#addModelDoiTuongSuDung">
...
<div class="container">
    <div id="test">
        <table class="table table-hover table-striped mb-5">
            ...
            <tbody>
            <c:forEach items="${listDoiTuong}" var="dt" varStatus="i">
                <tr>
                    ...
                    <td>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="/doi-tuong-su-dung/delete/${dt.id}"><i class="bi bi-trash3"></i> Xóa</a>
                            </li>
                            <li>
