...
<div class="container">
    <div class="title text-center pt-5">
        <h2 class="position-relative d-inline-block">QUẢN LÝ ĐỐI TUỌNG SẢN PHẨM</h2>
    </div>
    <div class="row">
        <button type="button" class="btn btn-outline-secondary mt-5 rounded-pill" data-bs-toggle="modal"
                data-bs-target="#modalAddDoiTuongSanPham">
            <i class="bi bi-bag-plus-fill"></i> <span>THÊM ĐỐI TUỌNG SẢN PHẨM</span>
        </button>
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <button type="button" class="dropdown-item" data-bs-toggle="modal"
                                        data-bs-target="#modalUpdate${dt.id}"><i
                            ...
                            <%--                        Modal update--%>
                        <div class="modal fade" id="modalUpdate${dt.id}" tabindex="-1"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group" hidden>
                                            <label  class="form-label">Id
                                                <span>*</span></label>
                                            <input value="${dt.id}" name="id" id="id" class="form-control"/>
                                        </div>
                                    </div>
                                    <div class="modal-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label  class="form-label">Mã
                                                        <span>*</span></label>
                                                    <input value="${dt.maDoiTuongSuDung}" name="maDoiTuongSuDung" id="maUpdate${dt.id}" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label  class="form-label">Tên Đối Tượng Sử Dụng
                                                        <span>*</span></label>
                                                    <input value="${dt.tenDoiTuongSuDung}" name="tenDoiTuongSuDung" id="tenUpdate${dt.id}" class="form-control"/>
                                            ...
                                            <div class="form-group">
                                                <label  class="form-label">Trạng thái
                                                    <span>*</span></label>
                                                <select name="trangThai" id="trangThaiUpdate${dt.id}" class="form-control">
                                    ...
                                    <div class="modal-footer justify-content-between">
                                        ...
                                        <button type="submit" id="uploadButton" class="btn btn-primary" onclick="updateDoiTuongSuDung(${dt.id})">Lưu</button>
                                    </div>
...
<script>
    ...
    function updateDoiTuongSuDung(id) {
