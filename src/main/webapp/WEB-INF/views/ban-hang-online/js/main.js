(function ($) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (existingProduct) {
                    ...
                    existingProduct.sl += quantityProduct;
                } else {
                    var product = {
                        id: selectedIdValue,
                        idProductForDetail: response.sanPham.id,
                        name: response.sanPham.tenSanPham,
                        price: response.giaBan,
                        img: anh,
                        sl: quantityProduct,
                ...
                for (var product2 of cart) {
                    ...
                    console.log("số lượng " + product2.sl)
        ...
        if (cart.length === 0) {
            ...
            for (var product of cart) {
                ...
                var itemHTML = ' <li class="header-cart-item flex-w flex-t m-b-12">\n' +
                    ...
                    '                        <a href="/sixdo-shop/product/' + product.idProductForDetail + '" class="header-cart-item-name m-b-5 hov-cl1 trans-04 font-weight-bold">' + product.name + ' \n' +
                    '                        </a> ' +
                    '                        <a href="/sixdo-shop/product/' + product.idProductForDetail + '"class="header-cart-item-name m-b-12 hov-cl1 trans-04">' + product.colorProduct + '</a>\n' +
                    '\n' +
                    '                        <span class="header-cart-item-info" > ' + product.sl + '  x  ' + formatter.format(product.price) + '</span> \n' +
                    '                    </div> \n' +
                    '                </li> '
                ;
                ...
                totalAmount += product.price * product.sl;
            }
    ...
    function updateCartOnPage(cart) {
        ...
        cart.forEach(function (product) {
            ...
            priceCell.textContent =tempNumberForVnd( product.price);
            ...
            quantityInput.value = product.sl;
            ...
            totalCell.textContent = tempNumberForVnd(product.sl * product.price);
            sumCartValues+=(product.sl * product.price)
